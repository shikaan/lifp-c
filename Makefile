...
tests/evaluate.test: lifp/evaluate.o lifp/node.o lib/list.o lib/arena.o lifp/environment.o lib/map.o lifp/value.o lifp/fmt.o
tests/map.test: lib/arena.o lib/map.o
tests/fmt.test: lifp/fmt.o lifp/node.o lib/arena.o lib/list.o lifp/value.o

tests/integration.test: lifp/tokenize.o lifp/parse.o lib/arena.o lifp/evaluate.o lib/list.o lib/map.o lifp/node.o lifp/environment.o lifp/value.o lifp/fmt.o
...
bin/run: lifp/tokenize.o lifp/parse.o lib/list.o lifp/evaluate.o lifp/node.o lib/arena.o lifp/environment.o lib/map.o lifp/fmt.o lifp/value.o lib/profile.o
